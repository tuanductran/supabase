...
const SubscriptionChangeSummaryPanel: FC<Props> = ({
  isRefreshingPreview,
  isSpendCapEnabled,
  subscriptionPreview,
  currentPlan,
      ...
      >
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between">
            <p className="text-scale-1100 line-through">{getPlanName(currentPlan)}</p>
            <p className="text-scale-1100 line-through">
...
export default SubscriptionChangeSummaryPanel
