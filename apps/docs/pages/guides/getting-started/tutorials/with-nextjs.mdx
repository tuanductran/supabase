...
Create a `middleware.js` file inside the `supabase-nextjs` directory and include the following content to:
...
Create a `middleware.ts` file inside the `supabase-nextjs` directory and include the following content to:
