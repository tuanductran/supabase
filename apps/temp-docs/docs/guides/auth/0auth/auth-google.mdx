...
parent: { label: 'adsdsa' }
breadcrumbs: true
subtitle: To enable Google Auth for your project, you need to set up a Google OAuth application and add the application credentials to your Supabase Dashboard.
---
