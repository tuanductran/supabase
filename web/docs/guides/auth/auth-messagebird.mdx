...
![Verify your own phone number](/img/guides/auth/auth-messagebird/1.png)

![Get your API Keys](/img/guides/auth/auth-messagebird/2.png)
...
![Set the default originator](/img/guides/auth/auth-messagebird/3.png)
