...
![Name your twilio project](/img/guides/auth/auth-twilio/1.png)
![verify your own phone number](/img/guides/auth/auth-twilio/2.png)

Select 'SMS', 'Identity & Verification', and 'With code' as options on the welcome form.

![Form Fields](/img/guides/auth/auth-twilio/3.png)
...
![Get a trial phone number](/img/guides/auth/auth-twilio/4.png)

![Successful phone number](/img/guides/auth/auth-twilio/5.png)
...
![All the credentials you'll need](/img/guides/auth/auth-twilio/6.png)
...
![Enable Phone Sign-Up](/img/guides/auth/auth-twilio/7.png)
...
![Plug in Twilio credentials](/img/guides/auth/auth-twilio/8.png)
