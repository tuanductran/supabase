...
![Register an application.](/img/guides/auth/auth-azure/azure-register-app.png)
...
![Obtain the client id](/img/guides/auth/auth-azure/azure-client-id.png)
...
![Obtain the client secret](/img/guides/auth/auth-azure/azure-client-secret.png)
