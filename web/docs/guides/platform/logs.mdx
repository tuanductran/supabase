...
![Sidebar navigation steps](/img/guides/platform/sidebar-navigation.png)
...
![Basic features](/img/guides/platform/basic-features.png)
...
![Enabling query mode](/img/guides/platform/query-mode.png)
...
![SELECT query example](/img/guides/platform/select-query.png)
...
![Templates](/img/guides/platform/templates.png)