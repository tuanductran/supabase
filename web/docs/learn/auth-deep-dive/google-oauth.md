...
![Create a new Google Project inside cloud console](/img/learn/google-oauth/auth-5-1.png)

Once you have a project, type "OAuth" into the search bar and open up "OAuth Consent Screen"

![Open the OAuth consent screen](/img/learn/google-oauth/auth-5-2.png)

Select 'External' and proceed to fill out the rest of the form fields

![Select External on the OAuth form](/img/learn/google-oauth/auth-5-3.png)

Next open up Credentials page on the left

![Open up Credentials page](/img/learn/google-oauth/auth-5-4.png)

And click to create a new set of credentials, select OAuth client ID as the option

![Create new oauth client id credentials](/img/learn/google-oauth/auth-5-5.png)
...
![Add your redirect URI](/img/learn/google-oauth/auth-5-6.png)
...
![take client id and secret](/img/learn/google-oauth/auth-5-7.png)

![insert client id and secret into supabase dashboard in auth > auth](/img/learn/google-oauth/auth-5-8.png)
